...
public class DvlpMain extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dvlp_main);
        ...
        switch (v.getId()){
            ...
            case R.id.tv_exec_register:
                if(mName.getText().toString().length()<4){
                    Toast.makeText(DvlpMain.this,"昵称格式不对"+mName.getText(),Toast.LENGTH_LONG).show();
                }else/* if(mCode.getText().toString().equals("0912"))*/ {
                    startActivity(new Intent(DvlpMain.this,SimpleHomeActivity.class));
                }
